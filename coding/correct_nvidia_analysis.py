# filename: correct_nvidia_analysis.py
...
# Extract specific columns using MultiIndex
close_column = ('Close', 'NVDA')
volume_column = ('Volume', 'NVDA')
...
average_volume = nvidia_data[volume_column].mean()
